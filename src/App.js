            ...
            <ThemeProvider theme={theme}>
                <Router>
                    ...
                    <Switch>
                        ...
                        <ProtectedRoute
                            path="/events"
                            component={Events}></ProtectedRoute>
                        <ProtectedRoute
                            path="/messages"
                            component={Messages}></ProtectedRoute>
                        <ProtectedRoute
                            path="/photos"
                            component={Photos}></ProtectedRoute>
                        <ProtectedRoute
                            path="/bookofshadows"
                            component={BookOfShadows}></ProtectedRoute>
                        <ProtectedRoute
                            path="/forum"
                            component={Forum}></ProtectedRoute>
                        <ProtectedRoute
                            path="/profile"
                            component={Profile}></ProtectedRoute>
                        <ProtectedRoute
                            path="/categories/:categoryId/newpost"
                            component={PostForm}></ProtectedRoute>
                        <ProtectedRoute
                            path="/categories/:categoryId/post/:id"
                            component={Post}></ProtectedRoute>
                        <ProtectedRoute
                            path="/categories/:id"
